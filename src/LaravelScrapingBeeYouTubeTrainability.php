...
final class LaravelScrapingBeeYouTubeTrainability
{
    use Conditionable;
    ...
    public function __construct(#[\SensitiveParameter] ?string $apiKey = null)
    {
        ...
        $this->baseUrl = config(
            'scrapingbee.youtube_trainability_base_url',
            'https://app.scrapingbee.com/api/v1/trainability'
        );
    }
    ...
    /**
     * Required
     * https://www.scrapingbee.com/documentation/youtube/?fpr=php-laravel#video_id_YouTubeTrainability
     */
